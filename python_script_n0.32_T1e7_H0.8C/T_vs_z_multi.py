...
#   hot = ad.cut_region("obj['temperature']>3e4")
   ...
   prof = yt.create_profile(ad,'z','temperature',units = {'z':'kpc'}, weight_field='cell_volume') 
   z=prof.x.value
   z_flux = prof['temperature'].value
...
plt.savefig('Temperature_vs_z_across'+str(num)+'.png')
