...
for i in num:
    ...
    ds = yt.load(filen)
    ad=ds.all_data() 
    profiles.append(yt.create_profile(ad,'number_density','cell_volume', weight_field=None, fractional=True, extrema={'number_density': (6e-4, 2.4e2)}) )
...
plt.ylim(5e-7,1)
plt.title(run)
plt.savefig('num_density_dist'+str(num)+'_fractional_2.png')
