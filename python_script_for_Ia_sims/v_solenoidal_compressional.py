...
#i print ('num_density=',ad['num_density'])
#  grad_num= ds.add_gradient_fields(('gas','num_density'))
#  print ('grad_num=',ad[grad_num[3]])

#  grad_phi = ds.add_gradient_fields(('gas','phi_v'))
#  print ('grad_phi=',ad[grad_phi[3]])
#  print (ad['phi_v'])
#  print (grad_phi)

#  print (ad['gas','number_density_gradient_x'])
#  print (ad['gas','phi_v_gradient_x']) 
